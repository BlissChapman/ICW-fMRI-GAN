...
def compute_accuracy(nn_classifier, brain_data, brain_data_tags):
    ...
    return nn_accuracy, random_accuracy, fraction_same_guesses
...
for training_step in range(1, TRAINING_STEPS + 1):
    ...
    if training_step % VISUALIZATION_INTERVAL == 0:
        ...
        nn_train_accuracy, random_train_accuracy, fraction_train_same_guesses = compute_accuracy(nn_classifier, train_brain_data_v, train_brain_data_tags)
